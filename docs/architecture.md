...
```
ui/src（Vue 3 SPA）──invoke(Channel)──▶ commands.rs ──▶ kernel.rs / plugins.rs ──▶ pnpm/git 子进程
                                   │              │
